...
function handleSubmit(e) {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-gray-800 via-gray-900 to-black flex justify-center items-center">
      ...
      <CardContent>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex-col gap-2 mt-4">
            <Button type="submit" className="w-[70%] mt-3 text-white">
              Login
            </Button>
          </CardFooter>
